...
def parse_args():
    ...
    parser.add_argument('--dataset', default='es-imagenet', help='dataset')
    parser.add_argument('--num-classes', type=int, default=1000, metavar='N',
                        help='number of label classes (default: 1000)')
    parser.add_argument('--data-path', default='./cifar10dvs', help='dataset')
...
def load_data(dataset_dir, distributed, T):
    ...
    origin_set = es_imagenet(root=dataset_dir, data_type='frame', frames_number=T, split_by='number')
        ...
        if output_dir:
            ...
            if save_max:
                utils.save_on_master(
                    checkpoint,
                    os.path.join(output_dir, 'logs/checkpoint_max_test_acc1.pth'))
        print(args)
