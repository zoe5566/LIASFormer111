...
def parse_args():
    ...
    parser.add_argument('--dataset', default='Ncalteth101', help='dataset')
...
def load_data(dataset_dir, distributed, T):
    ...
    transform = transforms.Compose([
        ...
        transforms.Pad((0, 30, 0, 30)),  # (左, 上, 右, 下) 填充
    ])

    origin_set = NCaltech101(root=dataset_dir, data_type='frame', frames_number=T, split_by='number',transform=transform)
